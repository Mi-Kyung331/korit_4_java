package ch14_abstraction.abstraction_class;

public class Main {
    public static void main(String[] args) {
        // phoneFactory
        PhoneFactory phoneFactory1 = new PhoneFactory();
        phoneFactory1.setName("애플 스마트폰 공장");    // 부분 메서드 사용
        phoneFactory1.produce("아이폰 17");    // 재정의한 메서드 # 1 → 추상 메서드
        phoneFactory1.manage();                     // 재정의한 메서드 # 2 → 추상 메서드
