...
public class ProductMain {
    public static void main(String[] args) {
        Method01.call();   // 그런데 다른 클래스에서 사용하려면 클래스명.메서드명();으로 호출
//        System.out.println(Arrays.toString());    // 이상의 방식의 호출을 이미 사용했습니다.
        ...
        // 결과적으로 인스턴스 변수는 객체에 종속되어있기 때문에 객체 생성 시에 0에서 1로 증가하는 것 밖에
        ...
        // singleton 패키지 생성 → projects 패키지 생성 → ProductView / ProductViewMain
