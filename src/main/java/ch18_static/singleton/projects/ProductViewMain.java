package ch18_static.singleton.projects;
...
//        producctView1.counter; 접근 불가능

        // 생성자를 private 처리를 했고, getInstance() 메서드 내에서 instance 정적 변수가 null이라면
        // instance = new ProductView();하기로 정의했었기 때문에 main 단계에서
        // 저희는 ProductView.getInstance();를 통해 객체를 생성합니다.
        ...
        /*
            이상의 코드에서 복수의 객체를 생성한 것 처럼 보이지만
            실제로 ProductView.getInstance();의 결과값은 동일한 instance입니다. (확인 필요)
