...
public class JSON2 {
    public static void main(String[] args) {
        ...
        // 1-2. setter 정의하려고 보니까 @Setter를 쓰면 되겠다 하면 이게 두번째 방법
        // 1-3. 그런데 생성하면서 동시에 속성값 넣고 싶으면 @AllArgsConstructor를 사용해도 되겠네요
        User user1 = new User("kim1", "9876", "a@test.com", "김일", "20");
        // 그러면 생성된 user1 인스턴스를 가지고 Json 데이터로 바꿀겁니다.
        ...
        // 2. JsonObject → json으로 변환 그런데 저희가 JSON1에서 했던겁니다.
        ...
        // gson 및 gsonBuilder를 이용하여 studnetJson을 두 번 출력한 결과값을 콘솔창에 띄울 수 있게 하세요
        studentJson = gsonBuilder.toJson(jsonObject1);
        System.out.println(studentJson);

        // 3. Map → Json 데이터로
        /*
            Map을 활용하여 key String / value String으로 선언하고, 객체명을 map1으로
            빈 map을 생성하시오
            ...
            gson 및 gsonBuilder를 활용하여 json 데이터로 바꿀겁니다 (그런데 얘기 좀 달라서 같이하겠습니다.)
         */
        ...
        // 하는 김에 Json 데이터들의 자료형이 전부 String인 것에 주목해야겠습니다.
        ...
        // gsonBuilder.toJson(map1)이든 gson.toJson(map1)이든 상관없습니다.
