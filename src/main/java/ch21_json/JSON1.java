...
public class JSON1 {
    public static void main(String[] args) {
        ...
        System.out.println(jsonObject1);
        // 결과값 : {"username":1,"password":1234,"email":"a@test.com","name":"김일","job":"코리아아이티아카데미국비강사"}
        /*
            콘솔에 출력된 값을 확인해보면 한 줄로 길게 늘어져 있습니다.
            addProperty()를 통해 키-값 쌍을 늘릴수록 계속 길어져서 가독성을 해치게 될 것으로 보입니다.
            .md 파일에서 작성한 것 처럼 key:value 마다 개행이 이루어지면 나을 것 같습니다.
            이 때 사용하는 것이 Gson 관련 클래스입니다.
         */
        Gson gson1 = new GsonBuilder().setPrettyPrinting().create();
        // method chaining 개념을 떠올리셔야합니다.
