...
public class StrMap {
    public static void main(String[] args) {
        ...
        // 결과값 : {kor2025004=김사, kor2025003=김삼, kor2025005=김오, kor2025002=김이, kor2025001=김일}

        strMap1.put("kor2025005", "KinFive");
        System.out.println(strMap1);
        // 결과값 : {kor2025004=김사, kor2025003=김삼, kor2025005=KinFive, kor2025002=김이, kor2025001=김일}
        ...
        // 특정 key의 value 조회
        System.out.println(strMap1.get("kor2025002"));  // 결과값 : 김이
        ...
        strMap1.replace("kor2025002", "KinTwo");
        ...
        // 결과값 : kor2025006 존재 여부 : false

        // 특정 값 존재 엽부 → containsValue(); → boolean
        boolean searchValueFlag1 = strMap1.containsValue("김삼");
        System.out.println("김삼의 존재 여부 : " + searchValueFlag1);
        // 결과값 : 김삼의 존재 여부 : true
        ...
        // 결과값 : [kor2025004=김사, kor2025003=김삼, kor2025005=KinFive, kor2025002=KinTwo, kor2025001=KimOne]
        // Map의 element를 Set에 삽입
        System.out.println(entrySet2.size());
        // 결과값 : 5
        // 5가 출력된다는 점에서 'key값 = value값'이 하나의 element로 잡힘


        List<Map.Entry<String, String>> entryList1 = new ArrayList<>();
//        List<Map<String, String>> entryList2 = strMap1.entrySet();
        // Map → List 대입이 불가능하다는 걸 보여주는 예시
        // 결국 Map에서 List로의 형변환을 하고 싶다면 Set을 경위해야합니다.
        ...
        // 결과값 : [kor2025004, kor2025003, kor2025005, kor2025002, kor2025001]

        // Value Set 출력
//        Set<String> valueSet = strMap1.values();
        // 오류발생 예시 → 필요한 타입 Set / 제공된 타입 Collection
        ...
        // 결과값 : [김사, 김삼, KinFive, KinTwo, KimOne]
        // 그 와중에 .sort() 할 때 처럼 Collections가 아니라 Collection입니다.
