...
/*
    주석(comment) : Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링하는데,
        ...
        즉, 주석이란 컴퓨터가 읽어서 처리하는 부분이 아니라 사람이 읽어서 정보를 얻을 수 있는데에 의의가 있습니다.
...
//        System.out.println(안녕하세요, 제 이름은 강미경입니다.); -> 오류 발생
        ...
        // 이상과 같은 방식의 코드 대입을 하드코딩이라는 표현을 씁니다.
        ...
        /*
            ...
            원하는 방식으로 출력되지 않습니다. (62번 라인)

            그렇기 때문에 저희는 63번 라인에서 sout()dml ()안에 ""를 넣어줌으로써,
...
//        int pi2 = 3.14;
        ...
        /*
            Java에서의 변수 표기 방식 :
                1. 카멜 표기법(Camel case)를 사용
                    : 첫 문자는 소문자로 시작
                      복수의 단어로 이루어졌을 경우 두 번째 단어의 첫 번째 문자만 대문자
                    ex) 한 단어 짜리 : result
        ...
        System.out.println("안녕하세요 제 이름은 " + name + "입니다. 제 전공은 " + major
                + "이고, 그래서 예전 직업은 " + previousJob + "이었습니다. 현재는 " + currentJob + "을(를) 가지고 있습니다.");
        ...
        // 제 전공은 어쩌고저쩌고학과이며, mbti는 불라블라입니다. 열심히 할게요!!!
